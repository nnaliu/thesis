...
def get_model():
    if args.model == 'CNN':
        ...
        m = models.LSTMClassifier(300, 300, vocab_size, 2, embeds=my_embed, n_layers=4, batch_sz=args.batch_size, features=True) # embedding dim, hidden dim, vocab_size, label_size
