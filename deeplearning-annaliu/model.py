...
class LSTMClassifier(nn.Module):
    def __init__(self, embedding_dim, hidden_dim, vocab_size, label_size, n_layers=1, batch_sz=128, dropout_p=0.25, bidirectional=True, features=False):
    ...
    def forward(self, inputs, features=None):
        ...
        output, hidden = self.lstm2(output, hidden2)
        #END NEW CODE
