...
if os.path.exists('my_model_aligned.bin'):
	...
	glove_filename = '../deeplearning-annaliu/.vector_cache/glove.42B.300d.txt'
	print("Reading GloVe")
	gmodel = KeyedVectors.load_word2vec_format(glove_filename, binary=False)
	word2vec_output = 'glove.42B.300d.txt.word2vec'
	print("Outputing GloVe in Word2Vec")
	...
	my_model_aligned.wv.save_word2vec_format('my_model_aligned.bin', binary=True)
